...
def predict():
    ...
    if output1>str(0.5):
        return render_template('prediction.html',pred='Your Device is in Danger.\nProbability of DoS Attack occuring is {}'.format(output1),bhai="Do Something ASAP....")
    elif output2>str(0.5):
        return render_template('prediction.html',pred='Your Device is in Danger.\nProbability of dataProbing attack occuring is {}'.format(output2),bhai="Do Something ASAP....")
    elif output3>str(0.5):
        return render_template('prediction.html',pred='Your Device is in Danger.\nProbability of Malitious Control attack occuring is {}'.format(output3),bhai="Do Something ASAP....")
    elif output4>str(0.5):
        return render_template('prediction.html',pred='Your Device is in Danger.\nProbability of Malitious Operation attack occuring is {}'.format(output4),bhai="Do Something ASAP....")
    elif output5>str(0.5):
        return render_template('prediction.html',pred='Your Device is in Danger.\nProbability of Scan Anomaly occuring is {}'.format(output5),bhai="Do Something ASAP....")
    elif output6>str(0.5):
        return render_template('prediction.html',pred='Your Device is in Danger.\nProbability of Spying attack occuring is {}'.format(output6),bhai="Do Something ASAP....")
    elif output7>str(0.5):
        return render_template('prediction.html',pred='Your Device is in Danger.\nProbability of Wrong Set Up Anomaly occuring is {}'.format(output7),bhai="Do Something ASAP....")
    else:
        return render_template('prediction.html',pred='Your Device is safe.\n Probability of attack is not occuring is {}'.format(output8),bhai="Your Device is Safe for now..")
